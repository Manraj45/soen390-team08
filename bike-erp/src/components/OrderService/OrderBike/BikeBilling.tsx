...
/*
  The BikeBilling component is the billing component associated to the orderBike page.
*/
        ...
        <div className="contents">
          {
            bikeOrderList.bikeOrderList.map((bikeSold: BikeSold) => (
              <Box key={bikeSold.description} className={styles.billingBox}>
                <RemoveCircleOutlineIcon onClick={() => { removeBikeOrderFromCart(bikeSold) }} className={styles.item}/>
