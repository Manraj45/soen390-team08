...
export class ReportDAO {
    ...
    public fetchSalesReportInfoCSV = (userEmail: string, startDate: string, endDate: string, myDataOnly: boolean) => {
    ...
    public fetchExpensesReportInfoCSV = (userEmail: string, startDate: string, endDate: string, myDataOnly: boolean) => {
        return new Promise<Array<any>>((resolve, reject) => {
